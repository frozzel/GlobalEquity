...
<body>
    <main>
        ...
        <div class="container-fluid row header">Meet ${devProArr[0]} Project Development Team</div>
    <div class="container-fluid">
      <div class="row  gx-3 align-items-center">
       ...
       for (let i = 1; i <devProArr.length; i++){
        ...
        if(devProArr[i].phone){
          cardHtml += `<p class="card-text"><span>Office Phone: </span>${devProArr[i].phone}</p>`
        }
        else if (devProArr[i].school){
          cardHtml+= `<p class="card-text"><span>School: </span>${devProArr[i].school}</p>`
        }
        else if (devProArr[i].github){
          cardHtml+= `<a href="https://github.com/${devProArr[i].github}" class="card-link">Github</a>`;
        }
    ...
    linkHtmlarr.push(footHtml);

       
       console.log(linkHtmlarr)
       return linkHtmlarr;
    }
}